...
export const collection = [
    ...
    },
    {
        ...
        projectDescription: `What kind of Developer without a Portfolio Website, right? I believe in saying: 'Simplicity is the soul of efficiency'. Used React JS and SASS to create simple and responsive design that is easy to navigate and read its contents.`,
    },
    {
        projectName: 'Aliens',
        projectLink:
            'https://guardians-of-the-galaxy-crazy-ugly-space-game.netlify.app/',
        projectImage: space,
