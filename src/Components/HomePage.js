            ...
            <div className='container'>
                <div className='info'>
                    <div className='about-me'>
                        <h2>About me</h2>
                        <p>Recent graduate from <a href='https://lambdaschool.com/about'>Lambda School</a> – awesome Software Engineering Academy with world class Instructors!
                        ...
                        In my free time, I love to get outside for mountain-biking, a good session at the gym, travel with my wife and keep building my swimming pool.</p>
                    </div>
